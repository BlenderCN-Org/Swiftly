...
# original by "Marco Crippa <thekrypt77@tiscali.it>, Dealga McArdle",
# https://archive.blender.org/wiki/index.php/Extensions:2.6/Py/Scripts/Render/Render_to_Print/
...
class RENDER_PT_print(Panel):
    bl_label = "Swiftly: Render to Print"
